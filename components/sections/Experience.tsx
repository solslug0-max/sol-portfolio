...
const experiences = [
    ...
    },
    {
        ...
        company: "STAR FILL",
        description: [
            "Generar reportes de Gestión Comercial y rendimiento de ventas a través de dashboards en Power BI",
            "Reportes semanales de KPIs del Canal Retail (Sodimac y Maestro) para stakeholders",
            "Desarrollo del forecast y proyección de la demanda en canal moderno (Sodimac, Maestro) y tradicional (Grifo y Lubricentros)",
            "Planificación de la estrategia de la Fuerza de Ventas en colaboración con otros departamentos",
            "Identificar y resolver problemas, innovación y mejora continua de procesos comerciales",
        ],
        tags: ["Power BI", "Excel Avanzado", "Forecast", "KPIs", "Gestión Comercial"],
        current: false,
    },
    {
        period: "Octubre 2019 — Julio 2020",
        badge: "Pasado",
        role: "Practicante de Omnimedia",
        company: "BELCORP",
        description: [
            "Manejo de estrategias SEO para ésika, L\u0027BEL y Cyzone en 12 países de LATAM",
            "Colaboración con equipos de marca y análisis para ejecutar estrategias de embudo completo",
            "Liderar la relación con agencia externa para sitios de contenido y e-commerce",
            "Auditorías técnicas, investigación de keywords y benchmarking para estrategias SEO",
            "Manejo de publicidad en Amazon con objetivo de conversión para ésika, L\u0027BEL y Cyzone",
            "Implementación e insights de creativos y reporting semanal a marcas",
        ],
        tags: ["SEO", "Amazon Ads", "Marketing Digital", "LATAM", "E-commerce"],
        current: false,
    }
];
